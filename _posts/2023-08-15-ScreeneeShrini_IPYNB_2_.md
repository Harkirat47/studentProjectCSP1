...
What does the Data Link Layer (Layer 2) focus on in a network?

Answer: b. Physical addressing
Explanation: The Data Link Layer deals with the physical addressing of devices using MAC (Media Access Control) addresses.

Which device operates at the Data Link Layer and uses MAC addresses for forwarding frames?

Answer: c. Switch
Explanation: Switches operate at Layer 2 (Data Link Layer) of the OSI model and use MAC addresses to efficiently forward frames within a local network.

In networking, what does a MAC address uniquely identify?

Answer: a. Devices on the same network
Explanation: A MAC address uniquely identifies devices within the same local network or LAN (Local Area Network).
What is the main function of switches in a network?

Answer: b. Frame forwarding
Explanation: The primary function of switches is to forward data frames based on MAC addresses, enabling efficient communication within a network.

Which layer of the OSI model deals with physical transmission, like Ethernet and network adaptors?

Answer: b. Physical Layer (Layer 1)
Explanation: The Physical Layer (Layer 1) manages the physical transmission of data, including Ethernet standards and hardware like network adapters.

What does Layer 3 (Network Layer) use for unique device identification between different networks?

Answer: a. IP addresses
Explanation: Layer 3 (Network Layer) uses IP addresses to uniquely identify devices across various networks or subnets.

Which protocol operates at Layer 4 and ensures reliable communication by acknowledging data receipt?

Answer: c. TCP (Transmission Control Protocol)
Explanation: TCP operates at the Transport Layer (Layer 4) and provides reliable, connection-oriented communication by acknowledging data receipt and ensuring data integrity.

What is the main difference between UDP and TCP in Layer 4?

Answer: c. TCP acknowledges data receipt, while UDP doesn't.
Explanation: TCP is a reliable, connection-based protocol that acknowledges data receipt, while UDP is a connectionless protocol that does not guarantee delivery or acknowledgment.

In a network, what does the Transport Layer manage?

Answer: c. Traffic flow between networks
Explanation: The Transport Layer manages end-to-end communication, including traffic flow control, error-checking, and multiplexing, between different devices and networks.

Why would you choose UDP over TCP for a real-time application like online gaming?

Answer: c. UDP provides faster communication.
Explanation: UDP is preferred for real-time applications, like online gaming, as it offers faster communication due to its lower overhead and lack of acknowledgment, which reduces latency compared to TCP.
